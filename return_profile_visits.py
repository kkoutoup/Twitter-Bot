...
def return_profile_visits(self):
  try:
    profile_visits = self.driver.find_elements_by_xpath('//h5[text()="%s Summary"]/following-sibling::div//div//div[@class="DataPoint-info metric-profile-views"]'%self.month_year)
    if profile_visits:
