...
def return_new_followers(self):
  try:
    new_followers = self.driver.find_elements_by_xpath('//h5[text()="%s Summary"]/following-sibling::div//div//div/following-sibling::div/following-sibling::div/following-sibling::div/following-sibling::div//div[@class="DataPoint-info metric-followers"]'%self.current_date)
    if new_followers:
